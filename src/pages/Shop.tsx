...
const categories = ['All', 'Smartphones', 'Laptops', 'Smartwatches', 'Audio', 'Tablets', 'Gaming', 'Accessories', 'Drones'];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="hidden lg:block w-64 flex-shrink-0">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 sticky top-24">
              <div className="mb-6">
                ...
                <Button variant="ghost" size="sm" className="text-indigo-600 dark:text-indigo-400 p-0 h-auto" onClick={() => {
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {categories.map(category => <div key={category} className="flex items-center">
                      <input type="radio" id={`category-${category}`} name="category" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" checked={selectedCategory === category} onChange={() => setSelectedCategory(category)} />
          ...
          <div className="flex-grow">
            ...
            {/* Products */}
            {sortedProducts.length > 0 ? <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
